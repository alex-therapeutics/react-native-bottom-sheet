...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
   ...
   */
  const [didMeasureScreen, setDidMeasureScreen] = (0, _react.useState)(false);
  const [screenOffset, setScreenOffset] = (0, _react.useState)(0);
  const handleFullWindowOverlayLayout = (0, _react.useCallback)(e => {
  ...
  }, /*#__PURE__*/_react.default.createElement(_reactNativeScreens.FullWindowOverlay, {
