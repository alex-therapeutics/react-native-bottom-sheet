import React, { useMemo, useCallback, forwardRef, useImperativeHandle, memo, useEffect, useState } from 'react';
...
const BottomSheetComponent = /*#__PURE__*/forwardRef(function BottomSheet(props, ref) {
  ...
  const handleFullWindowOverlayLayout = useCallback(e => {
  ...
  }, /*#__PURE__*/React.createElement(FullWindowOverlay, {
